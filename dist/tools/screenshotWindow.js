...
export function registerScreenshotWindowTool(server, screenshotService) {
    server.tool("screenshot_window", "Capture a screenshot of a specific window by ID or title. Returns base64 PNG image.", inputSchema, async (args) => {
        try {
...
//# sourceMappingURL=screenshotWindow.js.map